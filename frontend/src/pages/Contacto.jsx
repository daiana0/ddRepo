      ...
      <Box sx={{ backgroundColor: "#d2bde2", minHeight: "100vh", py: 6 }}>
        <Container maxWidth="lg">
          ...
          >
            ...
            >
              ¿Tienes alguna consulta o proyecto en mente? Estamos aquí para
              ayudarte. Completa el formulario o comunícate directamente con
              nosotros.
            </Typography>
          </Paper>
          ...
          <Paper
            elevation={2}
            sx={{ p: 5, borderRadius: 3, maxWidth: 700, mx: "auto" }}
          >
          ...
          <Paper
            elevation={2}
            sx={{ p: 0, mt: 5, borderRadius: 3, overflow: "hidden" }}
          >
            ...
            <Box sx={{ p: 3, textAlign: "center", backgroundColor: "#f8f9fa" }}>
              <Typography variant="body1" color="text.secondary">
                Te esperamos de{" "}
                <strong>lunes a viernes de 9:00 a 18:00hs</strong> y{" "}
                <strong>sábados de 9:00 a 13:00hs</strong>
              </Typography>
            </Box>
          </Paper>
        </Container>
