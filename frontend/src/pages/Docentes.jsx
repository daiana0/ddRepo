  ...
  const noticias = [
    {
      id: 1,
      titulo:
        "10 Estrategias Innovadoras para Captar la Atención de tus Alumnos",
      descripcion:
        "Descubre técnicas creativas y probadas para mantener el interés de los estudiantes en cada clase, desde dinámicas grupales hasta el uso inteligente de recursos visuales.",
    ...
    },
    {
      ...
      descripcion:
        "Una selección de las mejores plataformas y aplicaciones gratuitas que todo educador debería conocer para optimizar su trabajo y enriquecer sus clases.",
    ...
    },
    {
      ...
      descripcion:
        "Consejos prácticos y económicos para diseñar recursos educativos de calidad sin gastar de más, aprovechando materiales reciclados y herramientas accesibles.",
      categoria: "Recursos",
    ...
    },
    {
      ...
      descripcion:
        "Aprende técnicas para dar feedback efectivo que motive a tus estudiantes y mejore su rendimiento académico de manera significativa.",
      categoria: "Didáctica",
    ...
    },
    {
      ...
      descripcion:
        "Estrategias de gestión del tiempo y organización que te ayudarán a planificar mejor tus clases y reducir el estrés diario.",
      categoria: "Consejos",
    ...
    },
    {
      ...
      descripcion:
        "Exploramos cómo la IA puede transformar la educación y qué consideraciones éticas debemos tener como educadores.",
      categoria: "Tecnología",
    ...
    },
    {
      ...
      descripcion:
        "Ideas prácticas y ejercicios para estimular el pensamiento creativo y la innovación en estudiantes de todas las edades.",
      categoria: "Innovación",
      fecha: "25 Septiembre 2025",
      imagen:
        "https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?w=500&h=300&fit=crop",
      destacado: false,
    },
    {
      id: 8,
      ...
      descripcion:
        "Todo lo que necesitas saber sobre formatos, papeles y técnicas de impresión para crear material didáctico profesional.",
      categoria: "Recursos",
      ...
      <Box sx={{ backgroundColor: "#d2bde2", minHeight: "100vh", py: 6 }}>
        <Container maxWidth="lg">
          ...
          >
            ...
            >
              Recursos, consejos e ideas innovadoras para potenciar tu práctica
              educativa
            </Typography>
          </Paper>
